    ...
    navigation.setOptions({
      headerRight: () =>
        <View style={{ flexDirection: 'row', marginBottom: 10, }}>
          ...
          >
            <View style={{ marginRight: 5, backgroundColor: '#FFFFFF', padding: 10, borderRadius: 150 / 2 }}>
          ...
          <TouchableOpacity
            onPress={handleSignOut}
          >
            <View style={{ marginLeft: 5, backgroundColor: '#FFFFFF', padding: 10, borderRadius: 150 / 2 }}>
              <Image
